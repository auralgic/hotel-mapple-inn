...
// Exactly 16 Rooms: Floor 2 (201-208) & Floor 3 (301-308)
export const INITIAL_ROOMS: Room[] = [
  // --- FLOOR 2 (Rooms 201 - 208) ---
  {
    ...
    current_guest: {
      ...
      check_in: '2026-08-30T14:00:00Z',
      check_out: '2026-09-02T11:00:00Z',
      booking_id: 'bk-201',
    },
  ...
  },
  {
    ...
    current_guest: {
      ...
      check_in: '2026-08-29T16:00:00Z',
      check_out: '2026-09-01T11:00:00Z',
      booking_id: 'bk-305',
    },
  },
  {
...
export const INITIAL_ORDERS: Order[] = [
  {
    id: 'ord-201-1',
    order_number: 'MI-2026-000201',
    room_id: 'r-201',
    room_number: '201',
    booking_id: 'bk-201',
    guest_name: 'Vikram Sharma',
    guest_phone: '+91 98291 55667',
    guest_session_id: 'sess-201',
    items: [
      {
        id: 'oi-1',
        order_id: 'ord-201-1',
        menu_item_id: 'th4',
        item_name_snapshot: 'MappleInn Royal Special Thali',
        unit_price_snapshot: 300,
        quantity: 2,
        tax_rate_snapshot: 5,
        line_total: 600,
        note: 'Make dal less spicy please',
      },
      {
        id: 'oi-2',
        order_id: 'ord-201-1',
        menu_item_id: 'bev1',
        item_name_snapshot: 'Special Masala Chai',
    ...
    payment_status: 'paid',
    status: 'preparing',
    guest_note: 'Deliver quickly if possible',
    payment_id: 'pay-201-1',
    upi_reference: 'UPI/623491829304/Paytm',
    created_at: new Date(Date.now() - 15 * 60000).toISOString(),
    updated_at: new Date(Date.now() - 10 * 60000).toISOString(),
  },
  {
    id: 'ord-205-1',
    order_number: 'MI-2026-000205',
    room_id: 'r-205',
    room_number: '205',
    booking_id: 'bk-205',
    guest_name: 'Ananya Verma',
    guest_phone: '+91 94140 88990',
    guest_session_id: 'sess-205',
    items: [
      {
        id: 'oi-3',
        order_id: 'ord-205-1',
        menu_item_id: 'p3',
        item_name_snapshot: 'Spicy Paneer Pizza',
        unit_price_snapshot: 280,
        quantity: 1,
        tax_rate_snapshot: 5,
        line_total: 280,
      },
      {
        ...
        order_id: 'ord-205-1',
        menu_item_id: 'bev8',
        item_name_snapshot: 'Chilled Cold Coffee',
    ...
    status: 'new',
    payment_id: 'pay-205-1',
    upi_reference: 'UPI/623499112233/GPay',
...
export const INITIAL_PAYMENTS: Payment[] = [
  {
    ...
    upi_reference: 'UPI/623491829304/Paytm',
    status: 'verified',
    verified_by_name: 'Front Desk Reception',
...
export const INITIAL_BOOKINGS: Booking[] = [
  {
    ...
    guest: {
      ...
      notes: 'Prefers quiet room, business traveler.',
    },
    room_id: 'r-201',
...
export const INITIAL_AUDIT_LOGS: AuditLog[] = [
  {
    id: 'aud-1',
    actor_name: 'Front Desk Reception',
    action: 'VERIFY_PAYMENT',
    entity_type: 'PAYMENT',
    entity_id: 'pay-201-1',
    new_data: { status: 'verified', amount: 693, order_number: 'MI-2026-000201' },
  ...
  },
  {
    ...
    entity_type: 'BOOKING',
    entity_id: 'bk-205',
    new_data: { room_number: '205', guest_name: 'Ananya Verma' },
